...
- The environment you are using (OS, browser, SDK version, etc.)
...
- **Show and tell** – Share projects you've built using Nevermined.
- **General discussion** – Chat about anything related to Nevermined, AI agents, and the broader ecosystem.
...
- **Title**: Write a short, descriptive title that summarizes the issue.
- **Description**: Clearly explain what you observed, what you expected, and why the current behavior is a problem.
- **Context**: Include relevant details such as SDK version, runtime environment, browser, or API endpoint.
- **Reproducibility**: If reporting a bug, include the minimal steps needed to reproduce it consistently.
- **Attachments**: Include screenshots, logs, or code snippets where they help clarify the issue.
...
- **Be respectful and constructive** – Engage thoughtfully and assume good faith from others.
- **Stay on topic** – Keep threads focused and relevant to Nevermined and its ecosystem.
- **Search before posting** – Check whether a similar discussion already exists before starting a new one.
- **Use clear language** – Write clearly so that both native and non-native English speakers can follow.
- **Share context** – When asking for help, include enough context (code snippets, error messages, etc.) for others to understand your situation.

---

## Labels

We use labels to categorize and prioritize issues. Here are the key labels to be aware of:
